<p align="center">
 ...
 <h2 align="center">Corax For Java - Community Edition</h2>
  ...
  <p align="center">
    <a href="/docs/feature_diff.md">feature diff</a>
    ·
...
**Read the [Corax Community Edition Feature Comparison](docs/feature_diff.md) to understand the differences between the Corax Community and Commercial editions.**
...
**Read [CoraxJava Usage](docs/usage.md) for complete usage details.**

### CoraxJava+Docker

**If you want to experience scanning with Docker, read [CoraxJava+Docker Scanning Tutorial](docs/coraxdocker-usage.md) for complete usage details.**
...
**Read [Corax Community Edition Feature Comparison](docs/feature_diff.md#SAST Test Suite Performance) to understand the performance of this Java community edition tool on SAST test suites.**

## Custom Rule Checker

**Read [Corax Community Edition Feature Comparison](docs/feature_diff.md#Open Rules) to understand the open rules of this Java community edition tool.**

**If you need to implement a custom `CoraxJava rule checker`, refer to [CoraxJava Rule Checker](docs/checker.md) for more details.**
...
- Add the WeChat ID "Corax Community Assistant" and specify "Corax Community Edition Community Group" to be added to the group
