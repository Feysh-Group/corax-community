...
public class UnsafeSpringCsrfRequestMappingController {
    ...
    public void requestMappingNoMethod() {  // $SpringCsrfUnrestrictedRequestMapping
    }
    ...
    public void requestMappingEmptyMethod() {  // $SpringCsrfUnrestrictedRequestMapping
    }
    ...
    public void requestMappingUnprotectedAndProtectedMethods() {  // $SpringCsrfUnrestrictedRequestMapping
    }
    ...
    public void requestMappingUnprotectedAndProtectedUncommonMethods() {  // $SpringCsrfUnrestrictedRequestMapping
    }
    ...
    public void requestMappingAllUnprotectedMethodsAndOneProtectedMethod() {  // $SpringCsrfUnrestrictedRequestMapping
    }
    ...
    public void requestMappingAllProtectedMethodsAndOneUnprotectedMethod() {  // $SpringCsrfUnrestrictedRequestMapping
    }
