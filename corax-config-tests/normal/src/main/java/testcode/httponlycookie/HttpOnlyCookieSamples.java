package testcode.httponlycookie;
...
public class HttpOnlyCookieSamples {
    ...
    void multipleCookies(HttpServletResponse resp) {
        ...
        resp.addCookie(safeHttpOnlyCookie);  // !$HttponlyCookie
        ...
        resp.addCookie(unsafeHttpOnlyCookie);  // $HttponlyCookie
        ...
        resp.addCookie(unsafeCookie);  // $HttponlyCookie
        ...
        resp.addCookie(mixedCookies);  // $HttponlyCookie
        ...
        resp.addCookie(unsafeHttpOnlyCookie2);  // $HttponlyCookie

        Cookie safeHttpOnlyCookie2 = new Cookie("c2", "bar");
        safeHttpOnlyCookie2.setHttpOnly(true);
        resp.addCookie(safeHttpOnlyCookie2);  // !$HttponlyCookie
    }
}
